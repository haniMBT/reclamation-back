...
class NotificationService
{
    ...
    /**
     * Créer des notifications pour la clôture d'un ticket (optionnel pour plus tard)
     *
     * @param TRecTicket $ticket
     * @return void
     */
    public function createTicketClosureNotifications(TRecTicket $ticket): void
    {
        // TODO: Implémenter la logique pour la clôture de ticket
